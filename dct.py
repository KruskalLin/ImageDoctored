...
block_counter = 0
block_size = 8
image = cv2.imread('../dataset_copymove/images/a/a0001.jpg')
mask = cv2.imread('../dataset_copymove/masks/a/a0001.jpg')
...
cv2.imwrite('output_images/a0001.jpg', prediction_mask)
